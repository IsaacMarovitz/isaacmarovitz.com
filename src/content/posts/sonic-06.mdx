...
atprotoUri: "at://did:plc:ftdxrg5uqrtusxxoyqocrecq/site.standard.document/sonic-06"
---

import { Image } from "astro:assets";
import csc from "../../images/sonic-06/csc.png";
import castleTown from "../../images/sonic-06/castle-town.png";
import betaCastleTown from "../../images/sonic-06/beta-castle-town.png";
import billboard07 from "../../images/sonic-06/Billboard07.png";
import shadowAcne from "../../images/sonic-06/shadow-acne.png";
import lightsOverload from "../../images/sonic-06/lights-overload.png";
import multiplayer from "../../images/sonic-06/multiplayer.png";
...
<div class="flex justify-center overflow-clip flex-col md:flex-row">
  <div class="img-container">
    <Image src={csc} priority alt="Crisis City" class="zoomable-img" quality="high" />
    *Crisis City has reflections, particle effects, dramatic lighting.*
  </div>
  <div class="img-container">
    <Image src={castleTown} priority alt="Castle Town" class="zoomable-img" quality="high" />
...
<div class="img-container">
  <Image src={betaCastleTown} alt="Beta Castle Town" class="zoomable-img" quality="high" />
...
<div class="img-container">
  <Image src={billboard07} alt="Castle Town with Billboard07" class="zoomable-img" quality="high" />
...
<div class="img-container">
  <Image src={shadowAcne} alt="Shadow Acne" class="zoomable-img" quality="high" />
...
<div class="img-container">
  <Image src={lightsOverload} alt="Flame Core point lights" class="zoomable-img" quality="high" />
...
<div class="img-container">
  <Image src={multiplayer} alt="Kingdom Valley fixed cubemap" class="zoomable-img" quality="high" />
